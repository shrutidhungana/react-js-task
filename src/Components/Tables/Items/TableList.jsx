      ...
      {tables.length > 0 ? (
        <div>
            ...
            <table className = "table"  cellspacing="0" cellpadding="0">
              <thead>
              <tr>
               <th rowspan = "2" className = "th">Name</th>
               <th rowspan = "2" className = "th">Email</th>
               <th rowspan = "2" className = "th">Phone Number</th>
               <th rowspan = "2" className = "th">Date Of Birth</th>
               <th colspan = "4" className = "th">Address</th>
              </tr>
              <tr>
        ...
        <Paragraph>It seems like no data is entered.</Paragraph>
          ...
          <Button>
              <Link to="profile"className = "link">Profiles
              </Link>
          </Button>
    </div>
  )
